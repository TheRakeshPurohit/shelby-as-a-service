...
from services.deployment.deployment_service import ConfigTemplate, ConfigCreator, WorkflowBuilder
...
def run_sprite(moniker, platform):
    match platform:
        ...
        case 'slack':
            SlackSprite(moniker).run_slack_sprite()
        case _:
...
if __name__ == "__main__":
    ...
    group.add_argument('--build_workflow', help='Creates deployment workflow from deployment.env and config.yaml.')
