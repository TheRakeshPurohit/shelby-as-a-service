...
class DeploymentConfig:
    ...
    class MonikerConfigs:
        class TemplateName1:
            ...
            # Required #
            enabled_data_domains: list = ["tatum", "stackpath"]
            enabled: bool = True
            class DiscordConfig:
                # Required #
                enabled: bool = True
                ...
                discord_specific_channels_enabled: bool = None
