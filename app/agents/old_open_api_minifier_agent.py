### From https://github.com/ShelbyJenkins/LLM-OpenAPI-minifier
### Will implement
...
output_directory = 'app/index/minified_open_api_specs'
...
def run(openapi_specs):
    
    endpoints_by_tag_metadata, tag_summary_dict = minify(openapi_specs)
