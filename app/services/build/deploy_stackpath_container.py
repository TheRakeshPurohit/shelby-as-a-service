...
match DEPLOYMENT_TARGET:
    case "discord":
        config["payload"]["workload"]["spec"]["containers"]["webserver"]["env"] = {
            "DISCORD_TOKEN": {"value": os.environ.get("DISCORD_TOKEN")},
            ...
            "DISCORD_SHORT_MESSAGE": {"value": os.environ.get("DISCORD_SHORT_MESSAGE")},
            "DISCORD_MESSAGE_START": {"value": os.environ.get("DISCORD_MESSAGE_START")},
            "DISCORD_MESSAGE_END": {"value": os.environ.get("DISCORD_MESSAGE_END")},
        }
    case "slack":
        config["payload"]["workload"]["spec"]["containers"]["webserver"]["env"] = {
            "SLACK_BOT_TOKEN": {"value": os.environ.get("SLACK_BOT_TOKEN")},
            "SLACK_APP_TOKEN": {"value": os.environ.get("SLACK_APP_TOKEN")},
        }
    case _:
...
config["payload"]["workload"]["spec"]["containers"]["webserver"]["env"].update(
    {
        "OPENAI_API_KEY": {"value": os.environ.get("OPENAI_API_KEY")},
        "PINECONE_API_KEY": {"value": os.environ.get("PINECONE_API_KEY")},
        "VECTORSTORE_INDEX": {"value": os.environ.get("VECTORSTORE_INDEX")},
        "VECTORSTORE_NAMESPACES": {"value": os.environ.get("VECTORSTORE_NAMESPACES")},
        "ACTION_LLM_MODEL": {"value": os.environ.get("ACTION_LLM_MODEL")},
        "QUERY_LLM_MODEL": {"value": os.environ.get("QUERY_LLM_MODEL")},
        "VECTORSTORE_TOP_K": {"value": os.environ.get("VECTORSTORE_TOP_K")},
        "OPENAI_TIMEOUT_SECONDS": {"value": os.environ.get("OPENAI_TIMEOUT_SECONDS")},
        "MAX_DOCS_TOKENS": {"value": os.environ.get("MAX_DOCS_TOKENS")},
        "MAX_DOCS_USED": {"value": os.environ.get("MAX_DOCS_USED")},
        "MAX_RESPONSE_TOKENS": {"value": os.environ.get("MAX_RESPONSE_TOKENS")},
        ...
        "TIKTOKEN_ENCODING_MODEL": {"value": os.environ.get("TIKTOKEN_ENCODING_MODEL")},
        "PROMPT_TEMPLATE_PATH": {"value": os.environ.get("PROMPT_TEMPLATE_PATH")},
        "API_SPEC_PATH": {"value": os.environ.get("API_SPEC_PATH")},
    }
)
